...
class RunConfig:
    ...
    def __init__(self, resource_name_prefix="ialab-", inventory_fixture=None,
                 ...
                 regenerated=None, resolution_paths=None):
        ...
        # resolution_paths: the repository's committed path inventory for
        # repository-wide reference resolution (T23 #23 d2 resolves
        # derives_from to a repository path). The R4 CI wiring supplies it
        # when the run target is a staged subdomain of the repository;
        # absent, the target tree remains the resolution domain.
