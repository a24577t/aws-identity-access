...
- Wayfinder result records: [`docs/wayfinding/`](../../../docs/wayfinding/README.md) — the T19
  record is
...
- The open child tickets of map #1 (sub-issues with native blocked-by dependencies):
  https://github.com/a24577t/aws-identity-access/issues/1
- Frontier after T19: T10 #15 is first in map order and is unclaimed; T21 #20, T22 #21, and
  T23 #23 are also unblocked. T20 #22 (three open blockers: #15, #20, #21) and T14 #19 (four:
  #15, #20, #21, #22) remain blocked.
...
- Upstream proposals carried by Eric (not yet carried): document 09 (T02), document 05 (T02),
  ...
  (T08). None added by T19; OD-09 and OD-12 remain open platform-wide (T19 decision 20 makes
  OD-12 resolution or an owner-approved interim protocol a target-wave-0 prerequisite).
...
3. Load map #1.
4. Claim and work T10 #15 (https://github.com/a24577t/aws-identity-access/issues/15) under
...
- Read-only AWS discovery, when separately authorized, uses the established named lab profile
  ...
  snapshot contract, and the T19 (#14) adoption/migration strategy are targets, not
  authorizations. Nothing in GitHub (protections, environments, secrets, workflows) has been
  configured by the map; T06's mechanisms and T15's minimum control set are proposals for S5/S6
