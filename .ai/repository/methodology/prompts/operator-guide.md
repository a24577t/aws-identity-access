...
- **Expected outcome:** `.ai/repository/state/repository-continuity.md`, produced for human review and commit — carrying only uncommitted intent and pointers to authoritative artifacts, never a summary of committed work.
